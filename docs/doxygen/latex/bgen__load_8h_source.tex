...
\doxymbox{\hyperlink{bgen__load_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
\DoxyCodeLine{00001\ }
\DoxyCodeLine{00005\ }
\DoxyCodeLine{00006\ }
...
\DoxyCodeLine{00160\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ assert(\ sample\_indices-\/>size()\ ==\ result-\/>size()\ )\ ;}}
\DoxyCodeLine{00161\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00162\ }
...
\DoxyCodeLine{00206\ \ \ \ \ \ \ \ \ [[maybe\_unused]]\ \textcolor{keywordtype}{size\_t}\ m\_index\ ;}
