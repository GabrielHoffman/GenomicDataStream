...
\DoxyCodeLine{\mbox{\hyperlink{structgds_1_1_param}{Param}}\ param(file,\ field,\ region,\ samples,\ chunkSize);}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{//\ Initialise\ GenomicDataStream\ to\ read\ }}
\DoxyCodeLine{\textcolor{comment}{//\ VCF/VCFGZ/BCF\ and\ BGEN\ with\ same\ interface}}
...
\DoxyCodeLine{\mbox{\hyperlink{classgds_1_1_data_chunk}{DataChunk<arma::mat,\ VariantInfo>}}\ chunk;}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \textcolor{comment}{//\ chunk.getInfo();}}
\DoxyCodeLine{}
