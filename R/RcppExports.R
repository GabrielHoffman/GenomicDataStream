...
readData_rows <- function(x, start, length) {
    .Call('_GenomicDataStream_readData_rows', PACKAGE = 'GenomicDataStream', x, start, length)
}

readData_cols <- function(x, start, length) {
