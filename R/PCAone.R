...
#'}
#'
#' @details PCAone implements the window-based Randomized SVD proposed by Li, et al. (2023).
#' 
...
#' @rdname PCAone
#' @aliases PCAone,GenomicDataStream-method
setMethod(
  "PCAone", signature(x = "GenomicDataStream"),
...
setMethod("plot", signature(x = "PCA"), 
  ...
  plot(x$d, xlab = "Principal component", ylab = "Singular value", main=main, ...)  
})
