...
// fastLM2
List fastLM2(const arma::colvec& y, const std::string& file, const std::string& field, const std::string& region, const std::string& samples, const int& chunkSize, const bool& missingToMean);
RcppExport SEXP _GenomicDataStream_fastLM2(SEXP ySEXP, SEXP fileSEXP, SEXP fieldSEXP, SEXP regionSEXP, SEXP samplesSEXP, SEXP chunkSizeSEXP, SEXP missingToMeanSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::colvec& >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< const int& >::type chunkSize(chunkSizeSEXP);
    Rcpp::traits::input_parameter< const bool& >::type missingToMean(missingToMeanSEXP);
    rcpp_result_gen = Rcpp::wrap(fastLM2(y, file, field, region, samples, chunkSize, missingToMean));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_GenomicDataStream_fastLM2", (DL_FUNC) &_GenomicDataStream_fastLM2, 7},
    {NULL, NULL, 0}
};
